...
function resetPostgresql() {
  ...
  PGTABLES="jacl2_group jacl2_rights jacl2_subject jacl2_subject_group jacl2_user_group jsessions labels1_tests labels_tests product_tags_test product_test products testkvdb products_with_identity article3serial test_prod, jauthremembertoken"
