...
class jResponseBasicHtml extends jResponse
{
     ...
     *
     * @return null|jIHTMLResponsePlugin the plugin or null if it isn't loaded
     *
     * @since 1.3a1
     */
     ...
     * @param bool   $toTop   true if you want to add it at the top of the head content, else false for the bottom
     *
     * @since 1.0b1
     */
     ...
     * @param bool   $before  true if you want to add it before the content, else false for after
     */
     ...
     *
     * @return bool true if it is xhtml
     */
    final public function isXhtml()
    {
